    ...
    <>
      {token !== null && token !== "undefined" ? (
        <div className="justify-between flex flex-col h-screen  w-screen">
          <ChatNav />
          <h3 className=" p-2 rounded-lg px-4 mt-[100px] md:px-[150px]">
            Hey,{" "}
            <span className="text-blue-500 font-bold text-xl">Josphine</span>
          </h3>
          <div className="flex flex-1 flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch  md:px-[150px] mb-4 mt-4">
          ...
          <div className="shadow-lg shadow-black px-4 pt-4 py-4 sm:mb-0  bg-[#e9f1ff] md:px-[150px]">
            ...
            <footer className="w-full px-4 py-2 mt-4 text-center text-gray-500 text-sm">
              <p>
                InnerGlow AI 2024.Al rights reserved.Terms of services and
                Privacy policy
              </p>
            </footer>
          </div>
