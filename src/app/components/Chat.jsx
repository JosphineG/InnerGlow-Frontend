...
//     if (!prompt) {
//       toast.error("prompt should not be empty!", {
//         id: notification,
//       });
//       return;
//     }
//     if (prompt.length < 4) {
//       toast.error("prompt should be greater than 4 chars!", {
//         id: notification,
//       });
//       return;
//     }
//     try {
//       const response = await fetch(
//         `http://127.0.0.1:5000/api/v1/chat/geminichat`,
//         {
//           method: "POST",
//           headers: {
//             "Content-Type": "application/json",
